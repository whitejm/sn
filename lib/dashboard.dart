                            ...
                            children: [
                              ...
                              badges.Badge(
                                badgeStyle: const badges.BadgeStyle(
                                  badgeColor: Color.fromARGB(255, 0, 0, 128),
                                ),
                                badgeContent: Text(
                                  library.sortedNotebooks[index].newFlashcards
                                      .length
                                      .toString(),
                              ...
                              badges.Badge(
                                badgeStyle: const badges.BadgeStyle(
                                  badgeColor: Color.fromARGB(255, 128, 0, 0),
                                ),
                                badgeContent: Text(
                                  library.sortedNotebooks[index].dueFlashcards
                                      .length
                                      .toString(),
                                  style: const TextStyle(color: Colors.white),
                                ),
                              ...
                              badges.Badge(
                                badgeStyle: const badges.BadgeStyle(
                                  badgeColor: Color.fromARGB(255, 0, 128, 0),
                                ),
                                badgeContent: Text(
                                  library.sortedNotebooks[index].allFlashcards
                                      .length
                                      .toString(),
                                  style: const TextStyle(color: Colors.white),
                                ),
